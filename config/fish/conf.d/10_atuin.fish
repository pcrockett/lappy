# generated by `atuin init fish` and modified by phil

if not command -v atuin &>/dev/null
    # if i'm setting up a new computer, atuin isn't installed yet but my fish config is
    # probably in place.
    return
end
